package com.gasen.usercenter.service.impl;
...
import com.gasen.usercenter.mapper.UserMapper;
...
* @createDate 2023-12-10 20:46:16
*/
@Service
@Slf4j
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 混淆密码
     */
    public static final String salt = "gasen";
    @Override
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        if(user==null) {
            log.info("user login failer, userAccount cannot match userPassword");
            return null;
        }
        //3.用户脱敏
